...
# Page Header
st.title("🛍️ Buy Products with Beta")
                ...
                with cols[idx % 2]:
                    st.markdown(f"""
                        <div class='result-card'>
                            ...
                            <a href="{result['link']}" target="_blank"><button style="background-color: #FF6347; color: white; border: none; border-radius: 5px; padding: 10px 15px; cursor: pointer;">View Product_details</button></a>
                        </div>
                    """, unsafe_allow_html=True)
